...
from ultralytics.data import build_dataloader, build_yolo_dataset, build_yolomm_dataset, converter
...
class DetectionValidator(BaseValidator):
    ...
    def build_dataset(self, img_path: str, mode: str = "val", batch: int | None = None) -> torch.utils.data.Dataset:
        ...
        """
        return build_yolomm_dataset(self.args, img_path, batch, self.data, mode=mode, stride=self.stride)
