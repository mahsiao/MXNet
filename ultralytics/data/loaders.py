...
from ultralytics.data.mmdataset import SimOTM,SimOTMBBS,SimOTMSSS

class LoadMMImagesAndVideos:
    """
    ...
    def __init__(self, path, batch=1, vid_stride=1,imgsz=640):
...
# Define constants
LOADERS = (LoadStreams, LoadPilAndNumpy, LoadImagesAndVideos, LoadMMImagesAndVideos, LoadScreenshots)
